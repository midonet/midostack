...
$MIDO_DIR/scripts/setup_fake_uplink.sh -a $MIDONET_API_URI -u $MIDONET_USERNAME -p $MIDONET_PASSWORD -i $MIDONET_PROJECT_ID -c $MIDONET_CLIENT_DIR/src
$MIDO_DIR/scripts/verify_fake_uplink.sh -a $MIDONET_API_URI -u $MIDONET_USERNAME -p $MIDONET_PASSWORD -i $MIDONET_PROJECT_ID -c $MIDONET_CLIENT_DIR/src
